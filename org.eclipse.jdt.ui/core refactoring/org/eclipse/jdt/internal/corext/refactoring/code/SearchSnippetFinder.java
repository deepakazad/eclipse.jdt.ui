...
/* package */ class SearchSnippetFinder extends GenericVisitor {
	...
	private SearchSnippetFinder(ASTNode[] snippet) {
		super(true);
		fSnippet= snippet;
	...
	public static Match[] perform(ASTNode start, ASTNode[] snippet) {
		...
		SearchSnippetFinder finder= new SearchSnippetFinder(snippet);
		start.accept(finder);
